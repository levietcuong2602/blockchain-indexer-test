...
func GetTransactions(ctx context.Context, chain string,
...
func GetTransactionByHash(ctx context.Context, chain, hash string) (*TxResp, *httperr.Error) {
...
func GetTransactionsByUser(ctx context.Context, chain string,
